...
jest.mock('lucide-react', () => ({
    Users: () => <svg data-testid="users-icon" />, // Mock para el icono Users
    ChartColumnDecreasing: () => <svg data-testid="chart-bar-icon" />, // Mock para ChartColumnDecreasing
    Coins: () => <svg data-testid="cash-icon" />, // Mock para Coins
  }));
